import 'package:app_101/widgets/styled_wrapper_2.dart';
        ...
        child: Column(
          ...
          children: [
            const StyledWrapper2(
              ...
              children: [
                ...
                Expanded(child: Row(
                  ...
                  children: [
                    ImageIcon(AssetImage("res/icons/cup.png"), color: Color(0xFFFF8412), size: 18),
                    SizedBox(width: 4),
                    Text("50 Cities", style: TextStyle(
                ...
                Expanded(child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    ImageIcon(AssetImage("res/icons/flower.png"), color: Color(0xFFFF8412), size: 18),
                    SizedBox(width: 4),
                    Text("1 Lakh Patients", style: TextStyle(
                          fontFamily: "Kumbhsans",
                          fontWeight: FontWeight.w900,
                          fontSize: 10,
                          color: Color(0xFF211F2B)
                ...
                Expanded(child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    ImageIcon(AssetImage("res/icons/badge.png"), color: Color(0xFFFF8412), size: 18),
                    SizedBox(width: 4),
                    Text("60 Clinics", style: TextStyle(
                          fontFamily: "Kumbhsans",
                          fontWeight: FontWeight.w900,
                          fontSize: 10,
                          color: Color(0xFF211F2B)
            ...
            StyledWrapper2(
              child: Container(
                ...
                decoration: const BoxDecoration(
                  image: DecorationImage(image: AssetImage("res/images/map.png"))
                ),
              ),
            ),
            ...
            ValueListenableBuilder(
              ...
              builder: (_, val, __) {
                return StyledWrapper2(child: Container(
                    ...
                    child: DropdownButton2(
                      ...
                      dropdownStyleData: DropdownStyleData(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: const [
                            BoxShadow(
                              offset: Offset(0, 0), blurRadius: 20, spreadRadius: 0,
                        ...
                        scrollbarTheme: ScrollbarThemeData(
                          ...
                          trackColor: const MaterialStatePropertyAll(Color(0xFFC9DFF0)),
